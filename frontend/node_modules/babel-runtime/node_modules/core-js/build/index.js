...
(function(){
  var Promise, ref$, list, experimental, libraryBlacklist, es5SpecialCase, dashboard, readFile, writeFile, unlink, basename, dirname, join, webpack, temp;
  Promise = require('../library/fn/promise');
  ref$ = require('./config'), list = ref$.list, experimental = ref$.experimental, libraryBlacklist = ref$.libraryBlacklist, es5SpecialCase = ref$.es5SpecialCase, dashboard = ref$.dashboard;
