        ...
        results.forEach((data, index) => {
          ...
          if (commentsFile && extractedComments && extractedComments.length > 0) {
            ...
            if (extractedComments.length > 0) {
              // Add a dashboard to the original file
              if (this.options.extractComments.dashboard !== false) {
                let dashboard = this.options.extractComments.dashboard || `For license information please see ${_path.default.posix.basename(commentsFile)}`;

                if (typeof dashboard === 'function') {
                  dashboard = dashboard(commentsFile);
                }

                if (dashboard) {
                  outputSource = new _webpackSources.ConcatSource(`/*! ${dashboard} */\n`, outputSource);
                }
              }
